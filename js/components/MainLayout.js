...
export class MainLayout {
    ...
    render() {
        ...
        // ✅ 使用標準 SB Admin 2 結構 (#wrapper, .sidebar)
        return `
            <div id="wrapper">
    ...
    /**
     * 產生選單 HTML (適配 SB Admin 2 的 li.nav-item 結構)
     */
    buildMenuHtml(menus) {
    ...
    bindEvents() {
        ...
        const handleToggle = () => {
            ...
            if (sidebar.classList.contains('toggled')) {
                ...
                if (collapseEl) {
                    // Bootstrap 5 collapse logic if needed, but CSS usually handles it
                }
            };
        };
