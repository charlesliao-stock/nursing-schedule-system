...
export class UnitListPage {
            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card shadow-sm mb-4 border-left-primary">
                    <div class="card-body py-2 d-flex justify-content-end">
                        <button class="btn btn-primary w-auto text-nowrap" onclick="window.location.hash='/system/units/create'">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                <thead class="table-light"><tr><th>代碼</th><th>名稱</th><th>管理者數</th><th>排班者數</th><th class="text-end pe-3">操作</th></tr></thead>
    ...
    async afterRender() {
        ...
        window.deleteUnit = async (id) => { if(confirm('刪除？')) { await UnitService.deleteUnit(id); this.afterRender(); } };
    }
}
