                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <label class="form-label fw-bold">組別名稱</label>
                                <input type="text" id="new-group-name" class="form-control" placeholder="例如: A組">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary w-auto" data-bs-dismiss="modal">取消</button>
                                <button type="button" id="btn-save-group" class="btn btn-primary w-auto">新增</button>
                            </div>
                        </div>
                    </div>
                </div>
