...
export class ShiftSettingsPage {
    ...
    async render() {
        ...
        let unitOpts = '<option value="">載入中...</option>';
        if(isAdmin) {
        ...
        return `
            <div class="container-fluid mt-4">
                <div class="mb-3">
                    ...
                    <p class="text-muted small mb-0">定義該單位的班別代號、時間與顏色。</p>
                </div>
                ...
                <div class="card shadow-sm mb-4 border-left-primary">
                    <div class="card-body py-2 d-flex align-items-center gap-2">
                        ...
                        <button id="btn-add" class="btn btn-primary text-nowrap"><i class="fas fa-plus"></i> 新增班別</button>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                <thead class="table-light">
                                    <tr><th>代號</th><th>名稱</th><th>時間</th><th>顏色</th><th class="text-end pe-3">操作</th></tr>
                                </thead>
    ...
    renderTable() {
        ...
        if(this.shifts.length === 0) { tbody.innerHTML = '<tr><td colspan="5" class="text-center py-5 text-muted">尚無班別</td></tr>'; return; }
        ...
        tbody.innerHTML = this.shifts.map((s, i) => `
            <tr>
                ...
                <td><span class="badge" style="background:${s.color}; width:20px; height:20px;">&nbsp;</span></td>
