        ...
        return `
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card border-left-info shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">單位人數</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="dash-staff-count">...</div>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4" onclick="location.hash='/swaps/review'" style="cursor:pointer;">
                        <div class="card border-left-warning shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">待審核換班</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="dash-swap-count">...</div>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4" onclick="location.hash='/schedule/manual'" style="cursor:pointer;">
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">排班作業</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">進入管理</div>
                                    </div>
