...
export class PreScheduleManagePage {
    ...
    async render() {
        ...
        return mainLayout + contextMenu + modals;
    }
    ...
    renderReviewBody(schedule, daysInMonth) {
        ...
        this.reviewStaffList.forEach(staff => {
            ...
            html += `<tr><td class="sticky-col bg-white text-start ps-2" style="left:0;">${staff.name} <small class="text-muted">(${staff.rank})</small></td>`;
    ...
    handleCellClick(e, uid, day) {
        ...
        else { wishes[day] = 'M_OFF'; } // 管理者預設 M_OFF
