...
export class ScheduleListPage {
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead class="table-light">
                                    <tr>
                                        <th>月份</th>
                                        <th>預班狀態</th>
                                        <th>排班狀態</th> <th>審核狀態</th> <th>操作</th>
                                    </tr>
                                </thead>
                                <tbody id="schedule-list-tbody"><tr><td colspan="5" class="p-4 text-center">載入中...</td></tr></tbody>
                            </table>
                        </div>
                    </div>
                </div>
    ...
    async loadSchedules(unitId) {
        ...
        if (preSchedules.length === 0) {
            tbody.innerHTML = '<tr><td colspan="5" class="text-center p-4 text-muted">無資料</td></tr>';
            return;
        }
